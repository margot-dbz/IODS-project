...
# drop the former column crim and create a new table. I have to hide this since it does not allow me to knit my document for some reasons.
...
model_predictors <- select(train_data, -quantiles_crime)
